import {
  ...
  CFastImage, CIcon, CInput, CScrollView, CText, Container, IconType, KeyboardAvoidView, Row, SimpleLoader, Spacer, SubmitButton
} from "@app/components";
      ...
      <KeyboardAvoidView>
        ...
        <CScrollView>
          ...
          <AnimatedView
            ...
            direction="normal"
          >
            <CText>Bundle ID == {DeviceInfo.getBundleId()}</CText>
            <CText>App Name == {DeviceInfo.getApplicationName()}</CText>
            <CText>Config Name == {Config.API_URL}</CText>
          ...
          <Spacer />
          <AnimatedInput placeholder={'Hello Mr india'} value="Q" />
          <CInput
            value=""
            onChangeText={(val) => {
          ...
          <Row justifyContent="flex-start">
            ...
            <AnimatedText
              ...
              direction="normal"
            >
              Hello Mr. AnimatedText== {Config.ENVIRONMENT}
            </AnimatedText>
          </Row>
